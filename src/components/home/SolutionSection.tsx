      ...
      <div className="relative z-10 w-full max-w-7xl px-6 md:px-16 flex flex-col items-center gap-20">
        ...
        <div className="text-center flex flex-col gap-6">
          <h2 className="text-[40px] md:text-[54px] font-notch font-bold text-dark leading-tight">
            What Changes When the System is Right<span className="text-secondary">.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          {/* Card 1 */}
          <div className="relative bg-gradient-to-b from-white to-[#F2F4F8] rounded-[10px] h-[374px] shadow-[0px_4px_7px_rgba(0,0,0,0.07)] overflow-hidden flex flex-col items-center justify-center">
            {/* Top Border */}
            ...
            <div className="relative z-10 flex flex-col items-center gap-4 text-center px-4">
              <span className="text-[80px] md:text-[95px] font-notch font-bold leading-none bg-clip-text text-transparent bg-gradient-to-b from-primary to-secondary">
                3-5
              </span>
